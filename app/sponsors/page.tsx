...
const sponsors = {
    title: [
        {
            ...
            logo: "/sponsors/AtosLogofinal_edited.png",
            description:
    ...
    diamond: [
        {
            ...
            logo: "/sponsors/ANRF_Anushandhan.jpeg",
            description:
    ...
    platinum: [
        {
            ...
            logo: "/sponsors/Simco high definition.png",
            description:
    ...
    gold: [
        {
            ...
            logo: "/sponsors/ELTECH LOGO (1).png",
            description:
        ...
        },
        {
            ...
            logo: "/sponsors/Deepam Biotek.png",
            description:
    ...
    silver: [
        {
            ...
            logo: "/sponsors/swan-scientific-logo.png",
            description:
    ...
    bronze: [
        {
            name: "PerkinElmer",
            logo: "/sponsors/PerkinElmer SWP Full Color.jpg",
            description: "",
    ...
    award: [
        {
            name: "IOP Publishing",
            logo: "/sponsors/IOP_publishing.png",
            description: "",
        ...
        },
        {
            ...
            logo: "/sponsors/Power Beam Society.png",
            description: "",
    ...
    other: [
        {
            name: "COMSOL",
            logo: "/sponsors/comsol-logo-130x20.png",
            description: "",
            website: "https://www.comsol.com/",
        },
        {
            name: "PERIDOT",
            logo: "/sponsors/Peridot_logo.avif",
            description: "",
            website: "#",
        },
        {
            name: "Edmund Optics",
            logo: "/sponsors/Edmund Optics.jpeg",
            description: "",
            website: "https://www.edmundoptics.in/",
        },
        {
            name: "Britton Innotech",
            logo: "/sponsors/Britton_Innotech.jpeg",
            description: "",
            website: "#",
        },
        {
            name: "ISO",
            logo: "/sponsors/ISO_logo.jpg",
            description: "",
            website: "#",
        },
    ],
